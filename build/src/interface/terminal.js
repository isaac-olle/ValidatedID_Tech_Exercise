...
class TerminalInterface {
    constructor() {
        ...
        this.status = game_1.GameStatus.PlayersTurn;
    }
    Init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.game = new game_1.Game(numPlayers, numSquares, dice);
            this.game.Start();
            this.Play();
        });
    }
    ...
    Play() {
        while (true) {
            for (var player of this.game.GetPlayers()) {
                console.log(`It is Player ${player.GetId()}'s turn.`);
                if (game_1.GameStatus.Finished == this.game.Move(player)) {
                    console.log(`Congratulations! Player${player.GetId()} you have won the game!`);
                    return;
                }
            }
        }
